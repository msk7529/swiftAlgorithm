...
//  Algorithm
//
//  Created by kakao on 2021/08/08.
//
// https://github.com/raywenderlich/swift-algorithm-club/tree/master/Segment%20Tree

public class SegmentTree<T> {
    // leftBound, rightBound: 구하고자 하는 interval
    // leftChild, rightChild: child nodes를 가리키는 pointer
    // value: function의 결과값
    ...
    public func replaceItem(at index: Int, withItem item: T) {  // O(logN)
        if leftBound == rightBound {
            value = item
